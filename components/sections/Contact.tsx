  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        phone: (formData.get('phone') as string) || 'Non renseigné',
        service: (formData.get('subject') as string) || 'Non précisé',
        message: (formData.get('message') as string) || 'Demande de rendez-vous',
      }
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                ...
                {isSubmitted && (
                  <div className="bg-green-50 text-green-700 p-4 rounded-lg">
                    ...
                    <p className="text-sm mt-1">Je vous recontacterai sous 24h pour confirmer le créneau.</p>
                  </div>
                )}
